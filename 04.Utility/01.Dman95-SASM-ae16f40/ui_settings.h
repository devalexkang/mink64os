...
public:
    ...
    void setupUi(QWidget *SettingsWindow)
    {
        ...
        commonTab->setObjectName(QStringLiteral("commonTab"));
        verticalLayout_4 = new QVBoxLayout(commonTab);
        verticalLayout_4->setObjectName(QStringLiteral("verticalLayout_4"));
        commonSettingsBox = new QGroupBox(commonTab);
        commonSettingsBox->setObjectName(QStringLiteral("commonSettingsBox"));
        ...
        startWindowLabel->setObjectName(QStringLiteral("startWindowLabel"));
        ...
        language->addItem(QStringLiteral("Deutsch"));
        language->addItem(QStringLiteral("Italiano"));
        ...
        registersLabel_2->setObjectName(QStringLiteral("registersLabel_2"));
        ...
        registersYesRadioButton->setObjectName(QStringLiteral("registersYesRadioButton"));
        ...
        registersNoRadioButton->setObjectName(QStringLiteral("registersNoRadioButton"));
        ...
        insertDebugStringLabel->setObjectName(QStringLiteral("insertDebugStringLabel"));

        horizontalLayout_7->addWidget(insertDebugStringLabel);

        insertDebugStringCheckBox = new QCheckBox(commonSettingsBox);
        insertDebugStringCheckBox->setObjectName(QStringLiteral("insertDebugStringCheckBox"));
        ...
        codeSettingsBox->setObjectName(QStringLiteral("codeSettingsBox"));
        ...
        startTextWidget->setObjectName(QStringLiteral("startTextWidget"));
        ...
        iomacroBoldCheckBox->setObjectName(QStringLiteral("iomacroBoldCheckBox"));
        ...
        quotationColorButton->setObjectName(QStringLiteral("quotationColorButton"));
        ...
        systemColorButton->setObjectName(QStringLiteral("systemColorButton"));
        ...
        numbersItalicCheckBox->setObjectName(QStringLiteral("numbersItalicCheckBox"));
        ...
        numbersBoldCheckBox->setObjectName(QStringLiteral("numbersBoldCheckBox"));
        ...
        systemItalicCheckBox->setObjectName(QStringLiteral("systemItalicCheckBox"));
        ...
        commentsColorButton_2->setObjectName(QStringLiteral("commentsColorButton_2"));
        ...
        keywordsColorButton->setObjectName(QStringLiteral("keywordsColorButton"));
        ...
        commentsBoldCheckBox->setObjectName(QStringLiteral("commentsBoldCheckBox"));
        ...
        keywordsColorButton_2->setObjectName(QStringLiteral("keywordsColorButton_2"));
        ...
        iomacroColorButton_2->setObjectName(QStringLiteral("iomacroColorButton_2"));
        ...
        memoryItalicCheckBox->setObjectName(QStringLiteral("memoryItalicCheckBox"));
        ...
        keywordsLabel->setObjectName(QStringLiteral("keywordsLabel"));
        ...
        labelsColorButton->setObjectName(QStringLiteral("labelsColorButton"));
        ...
        numbersLabel->setObjectName(QStringLiteral("numbersLabel"));

        gridLayout_2->addWidget(numbersLabel, 3, 0, 1, 1);

        quotationColorButton_2 = new QPushButton(groupBox);
        quotationColorButton_2->setObjectName(QStringLiteral("quotationColorButton_2"));
        ...
        memoryColorButton->setObjectName(QStringLiteral("memoryColorButton"));
        ...
        systemColorButton_2->setObjectName(QStringLiteral("systemColorButton_2"));
        ...
        iomacroLabel_2->setObjectName(QStringLiteral("iomacroLabel_2"));

        gridLayout_2->addWidget(iomacroLabel_2, 9, 0, 1, 1);

        labelsColorButton_2 = new QPushButton(groupBox);
        labelsColorButton_2->setObjectName(QStringLiteral("labelsColorButton_2"));
        ...
        registersBoldCheckBox->setObjectName(QStringLiteral("registersBoldCheckBox"));
        ...
        quotationBoldCheckBox->setObjectName(QStringLiteral("quotationBoldCheckBox"));
        ...
        iomacroColorButton->setObjectName(QStringLiteral("iomacroColorButton"));
        ...
        iomacroItalicCheckBox->setObjectName(QStringLiteral("iomacroItalicCheckBox"));
        ...
        registersColorButton_2->setObjectName(QStringLiteral("registersColorButton_2"));
        ...
        keywordsBoldCheckBox->setObjectName(QStringLiteral("keywordsBoldCheckBox"));
        ...
        memoryBoldCheckBox->setObjectName(QStringLiteral("memoryBoldCheckBox"));
        ...
        numbersColorButton->setObjectName(QStringLiteral("numbersColorButton"));
        ...
        quotationItalicCheckBox->setObjectName(QStringLiteral("quotationItalicCheckBox"));
        ...
        commentsColorButton->setObjectName(QStringLiteral("commentsColorButton"));
        ...
        labelsItalicCheckBox->setObjectName(QStringLiteral("labelsItalicCheckBox"));
        ...
        iomacroLabel->setObjectName(QStringLiteral("iomacroLabel"));

        gridLayout_2->addWidget(iomacroLabel, 8, 0, 1, 1);

        keywordsItalicCheckBox = new QCheckBox(groupBox);
        keywordsItalicCheckBox->setObjectName(QStringLiteral("keywordsItalicCheckBox"));
        ...
        commentsItalicCheckBox->setObjectName(QStringLiteral("commentsItalicCheckBox"));
        ...
        labelsBoldCheckBox->setObjectName(QStringLiteral("labelsBoldCheckBox"));
        ...
        registersItalicCheckBox->setObjectName(QStringLiteral("registersItalicCheckBox"));
        ...
        systemBoldCheckBox->setObjectName(QStringLiteral("systemBoldCheckBox"));
        ...
        memoryColorButton_2->setObjectName(QStringLiteral("memoryColorButton_2"));
        ...
        registersColorButton->setObjectName(QStringLiteral("registersColorButton"));
        ...
        numbersColorButton_2->setObjectName(QStringLiteral("numbersColorButton_2"));
        ...
        fontColorButton->setObjectName(QStringLiteral("fontColorButton"));
        ...
        currentLineCheckBox->setObjectName(QStringLiteral("currentLineCheckBox"));

        gridLayout_4->addWidget(currentLineCheckBox, 5, 2, 1, 1);

        debugLineColorButton = new QPushButton(groupBox_2);
        debugLineColorButton->setObjectName(QStringLiteral("debugLineColorButton"));
        ...
        debugLineLabel->setObjectName(QStringLiteral("debugLineLabel"));

        gridLayout_4->addWidget(debugLineLabel, 6, 0, 1, 1);

        currentLineColorButton = new QPushButton(groupBox_2);
        currentLineColorButton->setObjectName(QStringLiteral("currentLineColorButton"));
        ...
        lineNumberPanelLabel->setObjectName(QStringLiteral("lineNumberPanelLabel"));

        gridLayout_4->addWidget(lineNumberPanelLabel, 2, 0, 1, 1);

        lineNumberPanelColorButton = new QPushButton(groupBox_2);
        lineNumberPanelColorButton->setObjectName(QStringLiteral("lineNumberPanelColorButton"));
        ...
        lineNumberFontLabel->setObjectName(QStringLiteral("lineNumberFontLabel"));

        gridLayout_4->addWidget(lineNumberFontLabel, 3, 0, 1, 1);

        lineNumberFontColorButton = new QPushButton(groupBox_2);
        lineNumberFontColorButton->setObjectName(QStringLiteral("lineNumberFontColorButton"));
        ...
        x86RadioButton->setObjectName(QStringLiteral("x86RadioButton"));
        ...
        x64RadioButton->setObjectName(QStringLiteral("x64RadioButton"));
        ...
        assemblerLabel->setObjectName(QStringLiteral("assemblerLabel"));
        ...
        nasmRadioButton->setObjectName(QStringLiteral("nasmRadioButton"));
        ...
        gasRadioButton->setObjectName(QStringLiteral("gasRadioButton"));
        ...
        fasmRadioButton->setObjectName(QStringLiteral("fasmRadioButton"));
        ...
        masmRadioButton->setObjectName(QStringLiteral("masmRadioButton"));
        ...
        assemblerWorkingDirectoryLabel->setObjectName(QStringLiteral("assemblerWorkingDirectoryLabel"));
        ...
        runInCurrentDirectoryCheckbox->setObjectName(QStringLiteral("runInCurrentDirectoryCheckbox"));
    ...
    void retranslateUi(QWidget *SettingsWindow)
    {
        ...
        settingsLabel->setText(QApplication::translate("SettingsWindow", "SASM Options", Q_NULLPTR));
        commonSettingsBox->setTitle(QApplication::translate("SettingsWindow", "Common", Q_NULLPTR));
        startWindowLabel->setText(QApplication::translate("SettingsWindow", "On start:", Q_NULLPTR));
        startWindow->clear();
        startWindow->insertItems(0, QStringList()
         << QApplication::translate("SettingsWindow", "Open get started window", Q_NULLPTR)
         << QApplication::translate("SettingsWindow", "Restore previous session", Q_NULLPTR)
        );
        languageLabel->setText(QApplication::translate("SettingsWindow", "Language:", Q_NULLPTR));
        language->setItemText(6, QApplication::translate("SettingsWindow", "Polski", Q_NULLPTR));
        language->setItemText(7, QApplication::translate("SettingsWindow", "\327\242\327\221\327\250\327\231\327\252", Q_NULLPTR));
        language->setItemText(8, QApplication::translate("SettingsWindow", "Espa\303\261ol", Q_NULLPTR));

        label_4->setText(QApplication::translate("SettingsWindow", "To apply the changes require a restart!", Q_NULLPTR));
        registersLabel_2->setText(QApplication::translate("SettingsWindow", "Show all registers in debug:", Q_NULLPTR));
        registersYesRadioButton->setText(QApplication::translate("SettingsWindow", "Yes", Q_NULLPTR));
        registersNoRadioButton->setText(QApplication::translate("SettingsWindow", "No, show only general purpose", Q_NULLPTR));
        insertDebugStringLabel->setText(QApplication::translate("SettingsWindow", "Insert debug string:", Q_NULLPTR));
        insertDebugStringCheckBox->setText(QString());
        codeSettingsBox->setTitle(QApplication::translate("SettingsWindow", "Code editor", Q_NULLPTR));
        fontLabel->setText(QApplication::translate("SettingsWindow", "Font:", Q_NULLPTR));
        fontSizeLabel->setText(QApplication::translate("SettingsWindow", "Size:", Q_NULLPTR));
        label->setText(QApplication::translate("SettingsWindow", "To apply the changes require a restart!", Q_NULLPTR));
        label_2->setText(QApplication::translate("SettingsWindow", "Default code editor text:", Q_NULLPTR));
        resetAllButton->setText(QApplication::translate("SettingsWindow", "Reset all (need a restart)...", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(commonTab), QApplication::translate("SettingsWindow", "Common", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("SettingsWindow", "Syntax highlighting", Q_NULLPTR));
        iomacroBoldCheckBox->setText(QString());
        systemLabel->setText(QApplication::translate("SettingsWindow", "System:", Q_NULLPTR));
        quotationColorButton->setText(QString());
        systemColorButton->setText(QString());
        numbersItalicCheckBox->setText(QString());
        label_6->setText(QApplication::translate("SettingsWindow", "Bold:", Q_NULLPTR));
        numbersBoldCheckBox->setText(QString());
        label_7->setText(QApplication::translate("SettingsWindow", "Italic:", Q_NULLPTR));
        label_3->setText(QApplication::translate("SettingsWindow", "Foreground:", Q_NULLPTR));
        ...
        keywordsLabel->setText(QApplication::translate("SettingsWindow", "Keywords:", Q_NULLPTR));
        label_5->setText(QApplication::translate("SettingsWindow", "Background:", Q_NULLPTR));
        labelsColorButton->setText(QString());
        numbersLabel->setText(QApplication::translate("SettingsWindow", "Numbers:", Q_NULLPTR));
        quotationColorButton_2->setText(QString());
        labelsLabel->setText(QApplication::translate("SettingsWindow", "Labels:", Q_NULLPTR));
        commentsLabel->setText(QApplication::translate("SettingsWindow", "Comments:", Q_NULLPTR));
        memoryColorButton->setText(QString());
        systemColorButton_2->setText(QString());
        iomacroLabel_2->setText(QApplication::translate("SettingsWindow", "Quotation:", Q_NULLPTR));
        ...
        memoryLabel->setText(QApplication::translate("SettingsWindow", "Memory:", Q_NULLPTR));
        iomacroLabel->setText(QApplication::translate("SettingsWindow", "I/O macro:", Q_NULLPTR));
        keywordsItalicCheckBox->setText(QString());
        registersLabel->setText(QApplication::translate("SettingsWindow", "Registers:", Q_NULLPTR));
        ...
        groupBox_2->setTitle(QApplication::translate("SettingsWindow", "Common", Q_NULLPTR));
        fontLabel_2->setText(QApplication::translate("SettingsWindow", "Font:", Q_NULLPTR));
        fontColorButton->setText(QString());
        currentLineCheckBox->setText(QApplication::translate("SettingsWindow", "Enable highlighting", Q_NULLPTR));
        debugLineColorButton->setText(QString());
        currentLineLabel->setText(QApplication::translate("SettingsWindow", "Current line:", Q_NULLPTR));
        debugLineLabel->setText(QApplication::translate("SettingsWindow", "Debugging line:", Q_NULLPTR));
        currentLineColorButton->setText(QString());
        backgroundLabel->setText(QApplication::translate("SettingsWindow", "Background:", Q_NULLPTR));
        backgroundColorButton->setText(QString());
        lineNumberPanelLabel->setText(QApplication::translate("SettingsWindow", "Line number panel:", Q_NULLPTR));
        lineNumberPanelColorButton->setText(QString());
        lineNumberFontLabel->setText(QApplication::translate("SettingsWindow", "Line number font:", Q_NULLPTR));
        lineNumberFontColorButton->setText(QString());
        label_8->setText(QApplication::translate("SettingsWindow", "To apply the changes require a restart!", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(colorsTab), QApplication::translate("SettingsWindow", "Colors", Q_NULLPTR));
        modeLabel->setText(QApplication::translate("SettingsWindow", "Mode:", Q_NULLPTR));
        x86RadioButton->setText(QApplication::translate("SettingsWindow", "x86", Q_NULLPTR));
        x64RadioButton->setText(QApplication::translate("SettingsWindow", "x64", Q_NULLPTR));
        assemblerLabel->setText(QApplication::translate("SettingsWindow", "Assembler:", Q_NULLPTR));
        nasmRadioButton->setText(QApplication::translate("SettingsWindow", "NASM", Q_NULLPTR));
        gasRadioButton->setText(QApplication::translate("SettingsWindow", "GAS", Q_NULLPTR));
        fasmRadioButton->setText(QApplication::translate("SettingsWindow", "FASM", Q_NULLPTR));
        masmRadioButton->setText(QApplication::translate("SettingsWindow", "MASM", Q_NULLPTR));
        assemblyLabel->setText(QApplication::translate("SettingsWindow", "Assembly options:", Q_NULLPTR));
        linkingLabel->setText(QApplication::translate("SettingsWindow", "Linking options:", Q_NULLPTR));
        assemblerPathLabel->setText(QApplication::translate("SettingsWindow", "Assembler path:", Q_NULLPTR));
        linkerPathLabel->setText(QApplication::translate("SettingsWindow", "Linker path:", Q_NULLPTR));
        objectFileNameLabel->setText(QApplication::translate("SettingsWindow", "Object file name:", Q_NULLPTR));
        disableLinkingLabel->setText(QApplication::translate("SettingsWindow", "Disable linking:", Q_NULLPTR));
        disableLinkingCheckbox->setText(QString());
        assemblerWorkingDirectoryLabel->setText(QApplication::translate("SettingsWindow", "Build in current directory:", Q_NULLPTR));
        runInCurrentDirectoryCheckbox->setText(QString());
        infoLabel->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(buildTab), QApplication::translate("SettingsWindow", "Build", Q_NULLPTR));
    } // retranslateUi
